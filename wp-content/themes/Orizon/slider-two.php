    <div id="homepage-carousel">
      ...
      <div class="homepage-news-item">
        <div class="hpn-image">
          <?php if ( has_post_thumbnail() ) {  the_post_thumbnail();} else{ ?><img src="<?php echo get_template_directory_uri(); ?>/images/nophoto.jpg" width="63" height="79"><?php } ?>
        </div>
        <div class="hpn-info">
          <a href="<?php the_permalink(); ?>" class="news-title"><?php if(strlen(get_the_title()) > 50){
    ...
    <div id="homepage-tab-carousel">
      <?php if (of_get_option('color_scheme')=="0" or of_get_option('color_scheme')=="1") { ?><img alt="alt_example" id="btd" src="<?php echo get_template_directory_uri(); ?>/css/red_css/images/banner_title_dent.png" name="btd">
      <?php } ?> <?php if (of_get_option('color_scheme')=="2") {?> <img alt="alt_example" id="btd" src="<?php echo get_template_directory_uri(); ?>/css/blue_css/images/banner_title_dent.png" name="btd"> <?php } ?> <?php
      ...
      <div class="tabs">
        <div class="banner_postimg">
          ...
          ?><img src="<?php echo get_template_directory_uri(); ?>/images/nophoto.jpg" width="63" height="79"> <?php } ?>
        </div>
       <h2><?php the_title(); ?></h2>
        <p>
          <?php
    ...
    <div id="da-slider" class="da-slider hidden">
      ...
      $baner_catgory_id = of_get_option('banner_fp_blog_category');
       wp_reset_query(); ?><?php query_posts('cat='.$baner_catgory_id.'&showposts='.$slider_image_count.'&order=DSC&orderby=post_date'); ?><?php  if ( have_posts() ) : ?><?php while ( have_posts() ) : the_post(); ?>
      <div class="da-slide">
